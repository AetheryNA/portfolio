...
const AboutMe = () => {
  ...
  return (
    <section className={`about-me h-screen flex flex-col mt-10 md:flex-row md:mt-44 ${inView ? 'in-view' : ''}`} ref={ref}>
      <div className="container container--small flex flex-col md:flex-row items-center">
        <div className="about-me__left flex flex-col md:w-5/12">
          ...
          <p className="mt-2.5 md:mt-5 relative about-me__para-2">
            Today however, I've worked for a maximum of 2 years and looking for adventure to further my knowledge in web development. I've worked for a <a href="/">small company</a> and a <a href="/">start up company</a> who's currently managing an ecommerce site that I was glad to be a part of!
          </p>
        ...
        <div className="about-me__right flex flex-col w-full mt-12 md:mt-0 md:w-4/12 md:ml-auto md:mr-8">
          <div className="about-me__right-wrap block w-3/5 md:w-full relative">
            <Image src="/images/aboutme.jpg" width={700} height={1000} layout='responsive' />
          </div>
        </div>
      </div>
    </section>
